...
responses_read$id<-row.names(responses_read)
```

##Calculating co-occurances

Using reshape and dplyr, we can count the coccurances of each picture in the responses.

```{r calculate}
table_test<-data.frame((responses_melt) %>% 
